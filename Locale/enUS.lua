...
L["EnablePortrait"] = "Enable portraits."
L["PortraitDescription"] = "When enabled enemy unit frame portraits will be replaced with something more appropriate to the enemy's class."
L["EnableSound"] = "Enable sounds."
L["SoundDescription"] = "Receive a few words of encouragement from HQ when you get a killing blow."
L["EnableNameplates"] = "Enable nameplates."
L["NameplatesDescription"] = "Displays Kill - Death score on enemy nameplates who maintain a 5 - 1 k/d ratio. Also the enemy player with the most kills in the BG gets a special icon. This way you know who is good at PvP."
L["EnableScore"] = "Enable Scoreboard."
L["ScoreDescription"] = "Displays your Kill/Death ratio in BGs. Lets face it, ctrl + space is just too inconvenient."
L["EnableFlash"] = "Enable Scoreboard flash."
L["FlashDescription"] = "When you are awarded a killing blow the score frame will flash. This gets annoying. So turn it off."
L["EnableRBG"] = "Enable in RBG's."
L["RBGDescription"] = "Enable MongoMon in Rated Battlegrounds (not recommended)."
L["Title"] = "MongoMon"
...
L["EnableAAR"] = "Enable After Action Report."
L["AARDescription"] = "Splash page summary showing your BG heroics after a match."
...
L["AARAutoSendDescription"] = "Too lazy to press the button? We got you covered. Automatically post After Action Report to chat."
L["AheadBy"] = "ahead by"
